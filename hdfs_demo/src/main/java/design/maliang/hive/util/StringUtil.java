...
public class StringUtil {
     ...
     */
    public static String underscoreUpperCaseName(String name) {
     ...
     */
    public static String underscoreLowerCaseName(String name){
        return underscoreUpperCaseName(name).toLowerCase();
    }
